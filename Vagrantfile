...
# Add packages to build and run tucano
...
sudo -u postgres createdb -U postgres tucano_development
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # access the development site at http://tucano.local.
  # If you change it, also change it in .env.vagrant before provisioning
  # the vagrant server to update the development build.
  #
  # To install:
  #   $ vagrant plugin install vagrant-hostsupdater
  config.vm.hostname = "tucano.local"
