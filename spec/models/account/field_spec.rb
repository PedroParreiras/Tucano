  ...
  describe '#verifiable?' do
    ...
    context 'with local accounts' do
      ...
      context 'with a URL with a non-normalized path' do
        let(:value) { 'https://github.com/octocatxxxxxxxx/../tucano' }
    ...
    context 'with remote accounts' do
      ...
      context 'with a link' do
        let(:value) { '<a href="https://www.patreon.com/tucano" target="_blank" rel="nofollow noopener noreferrer me"><span class="invisible">https://www.</span><span class="">patreon.com/tucano</span><span class="invisible"></span></a>' }
