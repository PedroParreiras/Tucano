...
namespace :repo do
  ...
  task :authors do
    ...
    file << <<~HEADER
      ...
      tucano is available on [GitHub](https://github.com/#{REPOSITORY_NAME})
  ...
  task check_locales_files: :environment do
    ...
    missing_json_files = I18n.available_locales.reject { |locale| Rails.root.join('app', 'javascript', 'tucano', 'locales', "#{locale}.json").exist? }
