...
- **Add notification policies, filtered notifications and notification requests** (#29366, #29529, #29433, #29565, #29567, #29572, #29575, #29588, #29646, #29652, #29658, #29666, #29693, #29699, #29737, #29706, #29570, #29752, #29810, #29826, #30114, #30251, #30559, #29868, #31008, #31011, #30996, #31149, #31220, #31222, #31225, #31242, #31262, #31250, #31273, #31310, #31316, #31322, #31329, #31324, #31331, #31343, #31342, #31309, #31358, #31378, #31406, #31256, #31456, #31419, #31457, #31508, #31540, and #31541 by @ClearlyClaire, @Gargron, @TheEssem, @mgmn, @oneiros, and @renchap)\
  ...
  - `GET /api/v2/notifications/policy`: https://docs.jointucano.org/methods/notifications/#get-policy
...
- Change cookie rotator to use SHA1 digest for new cookies (#27392 by @ClearlyClaire)\
  Note that this requires that no pre-4.2.0 tucano web server is running when this code is deployed, as those would not understand the new cookies.\
...
- Fix division by zero on some video/GIF files ([ClearlyClaire](https://github.com/tucano/tucano/pull/30600))
...
- Fix unblocking internationalized domain names under certain conditions ([tribela](https://github.com/tucano/tucano/pull/29530))
...
- Fix insufficient checking of remote posts ([GHSA-jhrq-qvrm-qr36](https://github.com/tucano/tucano/security/advisories/GHSA-jhrq-qvrm-qr36))
...
- Fix unsupported time zone or locale preventing sign-up ([Gargron](https://github.com/tucano/tucano/pull/28035))
...
- Fix processing LDSigned activities from actors with unknown public keys ([ClearlyClaire](https://github.com/tucano/tucano/pull/27474))
...
- Fix explore prompt appearing because of posts being received out of order ([ClearlyClaire](https://github.com/tucano/tucano/pull/27211))
...
- **Add admin notifications for new tucano versions** ([ClearlyClaire](https://github.com/tucano/tucano/pull/26582))
  This is done by querying `https://api.jointucano.org/update-check` every 30 minutes in a background job.
...
- Add `S3_ENABLE_CHECKSUM_MODE` environment variable to enable checksum verification on compatible S3-providers ([ClearlyClaire](https://github.com/tucano/tucano/pull/26435))
...
- Add onboarding prompt when home feed too slow in web UI ([Gargron](https://github.com/tucano/tucano/pull/25267), [ClearlyClaire](https://github.com/tucano/tucano/pull/25556), [Gargron](https://github.com/tucano/tucano/pull/25579), [renchap](https://github.com/tucano/tucano/pull/25580), [ClearlyClaire](https://github.com/tucano/tucano/pull/25581), [ClearlyClaire](https://github.com/tucano/tucano/pull/25617), [ClearlyClaire](https://github.com/tucano/tucano/pull/25917), [Gargron](https://github.com/tucano/tucano/pull/26829), [ClearlyClaire](https://github.com/tucano/tucano/pull/26935))
...
- Add support for streaming server to connect to postgres with self-signed certs through the `sslmode` URL parameter ([ramuuns](https://github.com/tucano/tucano/pull/21431))
...
- Change "bot" label to "automated" ([Gargron](https://github.com/tucano/tucano/pull/25356))
...
- Fix minor inefficiencies in `tootctl search deploy` ([ClearlyClaire](https://github.com/tucano/tucano/pull/26721))
...
- Fix unnecessary concurrent calls to `/api/*/instance` in web UI ([mgmn](https://github.com/tucano/tucano/pull/25663))
...
- Fix missing loading spinner and loading more on scroll in Private Mentions column ([c960657](https://github.com/tucano/tucano/pull/24446))
...
- **Fix blocking subdomains of an already-blocked domain** ([ClearlyClaire](https://github.com/tucano/tucano/pull/26392))
...
- Change profile updates to be sent to recently-mentioned servers ([ClearlyClaire](https://github.com/tucano/tucano/pull/24852))
- Change automatic post deletion thresholds and load detection ([ClearlyClaire](https://github.com/tucano/tucano/pull/24614))
- Change `/api/v1/statuses/:id/history` to always return at least one item ([ClearlyClaire](https://github.com/tucano/tucano/pull/25510))
- Change auto-linking to allow carets in URL query params ([renchap](https://github.com/tucano/tucano/pull/25216))

### Removed

- Remove invalid `X-Frame-Options: ALLOWALL` ([ClearlyClaire](https://github.com/tucano/tucano/pull/25070))

### Fixed

- Fix wrong view being displayed when a webhook fails validation ([ClearlyClaire](https://github.com/tucano/tucano/pull/25464))
- Fix soft-deleted post cleanup scheduler overwhelming the streaming server ([ThisIsMissEm](https://github.com/tucano/tucano/pull/25519))
- Fix incorrect pagination headers in `/api/v2/admin/accounts` ([danielmbrasil](https://github.com/tucano/tucano/pull/25477))
- Fix multiple inefficiencies in automatic post cleanup worker ([ClearlyClaire](https://github.com/tucano/tucano/pull/24607), [ClearlyClaire](https://github.com/tucano/tucano/pull/24785), [ClearlyClaire](https://github.com/tucano/tucano/pull/24840))
- Fix performance of streaming by parsing message JSON once ([ThisIsMissEm](https://github.com/tucano/tucano/pull/25278), [ThisIsMissEm](https://github.com/tucano/tucano/pull/25361))
- Fix CSP headers when `S3_ALIAS_HOST` includes a path component ([ClearlyClaire](https://github.com/tucano/tucano/pull/25273))
- Fix `tootctl accounts approve --number N` not approving N earliest registrations ([danielmbrasil](https://github.com/tucano/tucano/pull/24605))
- Fix reports not being closed when performing batch suspensions ([ClearlyClaire](https://github.com/tucano/tucano/pull/24988))
- Fix being able to vote on your own polls ([ClearlyClaire](https://github.com/tucano/tucano/pull/25015))
- Fix race condition when reblogging a status ([ClearlyClaire](https://github.com/tucano/tucano/pull/25016))
- Fix “Authorized applications” inefficiently and incorrectly getting last use date ([ClearlyClaire](https://github.com/tucano/tucano/pull/25060))
- Fix “Authorized applications” crashing when listing apps with certain admin API scopes ([ClearlyClaire](https://github.com/tucano/tucano/pull/25713))
- Fix multiple N+1s in ConversationsController ([ClearlyClaire](https://github.com/tucano/tucano/pull/25134), [ClearlyClaire](https://github.com/tucano/tucano/pull/25399), [ClearlyClaire](https://github.com/tucano/tucano/pull/25499))
- Fix user archive takeouts when using OpenStack Swift ([ClearlyClaire](https://github.com/tucano/tucano/pull/24431))
- Fix searching for remote content by URL not working under certain conditions ([ClearlyClaire](https://github.com/tucano/tucano/pull/25637))
- Fix inefficiencies in indexing content for search ([VyrCossont](https://github.com/tucano/tucano/pull/24285), [VyrCossont](https://github.com/tucano/tucano/pull/24342))

### Security

- Add finer permission requirements for managing webhooks ([ClearlyClaire](https://github.com/tucano/tucano/pull/25463))
- Update dependencies
- Add hardening headers for user-uploaded files ([ClearlyClaire](https://github.com/tucano/tucano/pull/25756))
...
- Fix crash in `tootctl` commands making use of parallelization when Elasticsearch is enabled ([ClearlyClaire](https://github.com/tucano/tucano/pull/24182), [ClearlyClaire](https://github.com/tucano/tucano/pull/24377))
- Fix crash in `db:setup` when Elasticsearch is enabled ([rrgeorge](https://github.com/tucano/tucano/pull/24302))
- Fix user archive takeout when using OpenStack Swift or S3 providers with no ACL support ([ClearlyClaire](https://github.com/tucano/tucano/pull/24200))
- Fix invalid/expired invites being processed on sign-up ([ClearlyClaire](https://github.com/tucano/tucano/pull/24337))

### Security

- Update Ruby to 3.0.6 due to ReDoS vulnerabilities ([saizai](https://github.com/tucano/tucano/pull/24334))
- Fix unescaped user input in LDAP query ([ClearlyClaire](https://github.com/tucano/tucano/pull/24379))

## [4.1.1] - 2023-03-16

### Added

- Add redirection from paths with url-encoded `@` to their decoded form ([thijskh](https://github.com/tucano/tucano/pull/23593))
- Add `lang` attribute to native language names in language picker in Web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/23749))
- Add headers to outgoing mails to avoid auto-replies ([ClearlyClaire](https://github.com/tucano/tucano/pull/23597))
- Add support for refreshing many accounts at once with `tootctl accounts refresh` ([9p4](https://github.com/tucano/tucano/pull/23304))
- Add confirmation modal when clicking to edit a post with a non-empty compose form ([PauloVilarinho](https://github.com/tucano/tucano/pull/23936))
- Add support for the HAproxy PROXY protocol through the `PROXY_PROTO_V1` environment variable ([CSDUMMI](https://github.com/tucano/tucano/pull/24064))
- Add `SENDFILE_HEADER` environment variable ([Gargron](https://github.com/tucano/tucano/pull/24123))
- Add cache headers to static files served through Rails ([Gargron](https://github.com/tucano/tucano/pull/24120))

### Changed

- Increase contrast of upload progress bar background ([toolmantim](https://github.com/tucano/tucano/pull/23836))
- Change post auto-deletion throttling constants to better scale with server size ([ClearlyClaire](https://github.com/tucano/tucano/pull/23320))
- Change order of bookmark and favourite sidebar entries in single-column UI for consistency ([TerryGarcia](https://github.com/tucano/tucano/pull/23701))
- Change `ActivityPub::DeliveryWorker` retries to be spread out more ([ClearlyClaire](https://github.com/tucano/tucano/pull/21956))

### Fixed

- Fix “Remove all followers from the selected domains” also removing follows and notifications ([ClearlyClaire](https://github.com/tucano/tucano/pull/23805))
- Fix streaming metrics format ([emilweth](https://github.com/tucano/tucano/pull/23519), [emilweth](https://github.com/tucano/tucano/pull/23520))
- Fix case-sensitive check for previously used hashtags in hashtag autocompletion ([deanveloper](https://github.com/tucano/tucano/pull/23526))
- Fix focus point of already-attached media not saving after edit ([ClearlyClaire](https://github.com/tucano/tucano/pull/23566))
- Fix sidebar behavior in settings/admin UI on mobile ([wxt2005](https://github.com/tucano/tucano/pull/23764))
- Fix inefficiency when searching accounts per username in admin interface ([ClearlyClaire](https://github.com/tucano/tucano/pull/23801))
- Fix duplicate “Publish” button on mobile ([ClearlyClaire](https://github.com/tucano/tucano/pull/23804))
- Fix server error when failing to follow back followers from `/relationships` ([ClearlyClaire](https://github.com/tucano/tucano/pull/23787))
- Fix server error when attempting to display the edit history of a trendable post in the admin interface ([ClearlyClaire](https://github.com/tucano/tucano/pull/23574))
- Fix `tootctl accounts migrate` crashing because of a typo ([ClearlyClaire](https://github.com/tucano/tucano/pull/23567))
- Fix original account being unfollowed on migration before the follow request to the new account could be sent ([ClearlyClaire](https://github.com/tucano/tucano/pull/21957))
- Fix the “Back” button in column headers sometimes leaving tucano ([c960657](https://github.com/tucano/tucano/pull/23953))
- Fix pgBouncer resetting application name on every transaction ([Gargron](https://github.com/tucano/tucano/pull/23958))
- Fix unconfirmed accounts being counted as active users ([ClearlyClaire](https://github.com/tucano/tucano/pull/23803))
- Fix `/api/v1/streaming` sub-paths not being redirected ([ClearlyClaire](https://github.com/tucano/tucano/pull/23988))
- Fix drag'n'drop upload area text that spans multiple lines not being centered ([vintprox](https://github.com/tucano/tucano/pull/24029))
- Fix sidekiq jobs not triggering Elasticsearch index updates ([ClearlyClaire](https://github.com/tucano/tucano/pull/24046))
- Fix tags being unnecessarily stripped from plain-text short site description ([c960657](https://github.com/tucano/tucano/pull/23975))
- Fix HTML entities not being un-escaped in extracted plain-text from remote posts ([c960657](https://github.com/tucano/tucano/pull/24019))
- Fix dashboard crash on ElasticSearch server error ([ClearlyClaire](https://github.com/tucano/tucano/pull/23751))
- Fix incorrect post links in strikes when the account is remote ([ClearlyClaire](https://github.com/tucano/tucano/pull/23611))
- Fix misleading error code when receiving invalid WebAuthn credentials ([ClearlyClaire](https://github.com/tucano/tucano/pull/23568))
- Fix duplicate mails being sent when the SMTP server is too slow to close the connection ([ClearlyClaire](https://github.com/tucano/tucano/pull/23750))

### Security

- Change user backups to use expiring URLs for download when possible ([Gargron](https://github.com/tucano/tucano/pull/24136))
- Add warning for object storage misconfiguration ([ClearlyClaire](https://github.com/tucano/tucano/pull/24137))

## [4.1.0] - 2023-02-10

### Added

- **Add support for importing/exporting server-wide domain blocks** ([enbylenore](https://github.com/tucano/tucano/pull/20597), [ClearlyClaire](https://github.com/tucano/tucano/pull/21471), [dariusk](https://github.com/tucano/tucano/pull/22803), [ClearlyClaire](https://github.com/tucano/tucano/pull/21470))
- **Add listing of followed hashtags** ([connorshea](https://github.com/tucano/tucano/pull/21773))
- **Add support for editing media description and focus point of already-sent posts** ([ClearlyClaire](https://github.com/tucano/tucano/pull/20878))
...
- **Add follow request banner on account header** ([ClearlyClaire](https://github.com/tucano/tucano/pull/20785))
  - REST API changes:
...
- **Add confirmation screen when handling reports** ([ClearlyClaire](https://github.com/tucano/tucano/pull/22375), [Gargron](https://github.com/tucano/tucano/pull/23156), [tribela](https://github.com/tucano/tucano/pull/23178))
- Add option to make the landing page be `/about` even when trends are enabled ([ClearlyClaire](https://github.com/tucano/tucano/pull/20808))
- Add `noindex` setting back to the admin interface ([prplecake](https://github.com/tucano/tucano/pull/22205))
- Add instance peers API endpoint toggle back to the admin interface ([dariusk](https://github.com/tucano/tucano/pull/22810))
- Add instance activity API endpoint toggle back to the admin interface ([dariusk](https://github.com/tucano/tucano/pull/22833))
- Add setting for status page URL ([Gargron](https://github.com/tucano/tucano/pull/23390), [ClearlyClaire](https://github.com/tucano/tucano/pull/23499))
  - REST API changes:
    - Add `configuration.urls.status` attribute to the object returned by `GET /api/v2/instance`
- Add `account.approved` webhook ([Saiv46](https://github.com/tucano/tucano/pull/22938))
- Add 12 hours option to polls ([Pleclown](https://github.com/tucano/tucano/pull/21131))
- Add dropdown menu item to open admin interface for remote domains ([ClearlyClaire](https://github.com/tucano/tucano/pull/21895))
- Add `--remove-headers`, `--prune-profiles` and `--include-follows` flags to `tootctl media remove` ([evanphilip](https://github.com/tucano/tucano/pull/22149))
- Add `--email` and `--dry-run` options to `tootctl accounts delete` ([ClearlyClaire](https://github.com/tucano/tucano/pull/22328))
- Add `tootctl accounts migrate` ([ClearlyClaire](https://github.com/tucano/tucano/pull/22330))
- Add `tootctl accounts prune` ([tribela](https://github.com/tucano/tucano/pull/18397))
- Add `tootctl domains purge` ([ClearlyClaire](https://github.com/tucano/tucano/pull/22063))
- Add `SIDEKIQ_CONCURRENCY` environment variable ([muffinista](https://github.com/tucano/tucano/pull/19589))
- Add `DB_POOL` environment variable support for streaming server ([Gargron](https://github.com/tucano/tucano/pull/23470))
- Add `MIN_THREADS` environment variable to set minimum Puma threads ([jimeh](https://github.com/tucano/tucano/pull/21048))
- Add explanation text to log-in page ([ClearlyClaire](https://github.com/tucano/tucano/pull/20946))
- Add user profile OpenGraph tag on post pages ([bramus](https://github.com/tucano/tucano/pull/21423))
- Add maskable icon support for Android ([workeffortwaste](https://github.com/tucano/tucano/pull/20904))
- Add Belarusian to supported languages ([Mixaill](https://github.com/tucano/tucano/pull/22022))
- Add Western Frisian to supported languages ([ykzts](https://github.com/tucano/tucano/pull/18602))
- Add Montenegrin to the language picker ([ayefries](https://github.com/tucano/tucano/pull/21013))
- Add Southern Sami and Lule Sami to the language picker ([Jullan-M](https://github.com/tucano/tucano/pull/21262))
- Add logging for Rails cache timeouts ([ClearlyClaire](https://github.com/tucano/tucano/pull/21667))
- Add color highlight for active hashtag “follow” button ([MFTabriz](https://github.com/tucano/tucano/pull/21629))
- Add brotli compression to `assets:precompile` ([Izorkin](https://github.com/tucano/tucano/pull/19025))
- Add “disabled” account filter to the `/admin/accounts` UI ([tribela](https://github.com/tucano/tucano/pull/21282))
- Add transparency to modal background for accessibility ([edent](https://github.com/tucano/tucano/pull/18081))
- Add `lang` attribute to image description textarea and poll option field ([c960657](https://github.com/tucano/tucano/pull/23293))
- Add `spellcheck` attribute to Content Warning and poll option input fields ([c960657](https://github.com/tucano/tucano/pull/23395))
- Add `title` attribute to video elements in media attachments ([bramus](https://github.com/tucano/tucano/pull/21420))
- Add left and right margins to emojis ([dsblank](https://github.com/tucano/tucano/pull/20464))
- Add `roles` attribute to `Account` entities in REST API ([ClearlyClaire](https://github.com/tucano/tucano/pull/23255), [tribela](https://github.com/tucano/tucano/pull/23428))
- Add `reading:autoplay:gifs` to `/api/v1/preferences` ([j-f1](https://github.com/tucano/tucano/pull/22706))
- Add `hide_collections` parameter to `/api/v1/accounts/credentials` ([CarlSchwan](https://github.com/tucano/tucano/pull/22790))
- Add `policy` attribute to web push subscription objects in REST API at `/api/v1/push/subscriptions` ([ClearlyClaire](https://github.com/tucano/tucano/pull/23210))
- Add metrics endpoint to streaming API ([Gargron](https://github.com/tucano/tucano/pull/23388), [Gargron](https://github.com/tucano/tucano/pull/23469))
- Add more specific error messages to HTTP signature verification ([ClearlyClaire](https://github.com/tucano/tucano/pull/21617))
- Add Storj DCS to cloud object storage options in the `tucano:setup` rake task ([jtolio](https://github.com/tucano/tucano/pull/21929))
- Add checkmark symbol in the checkbox for sensitive media ([sidp](https://github.com/tucano/tucano/pull/22795))
- Add missing accessibility attributes to logout link in modals ([kytta](https://github.com/tucano/tucano/pull/22549))
- Add missing accessibility attributes to “Hide image” button in `MediaGallery` ([hs4man21](https://github.com/tucano/tucano/pull/22513))
- Add missing accessibility attributes to hide content warning field when disabled ([hs4man21](https://github.com/tucano/tucano/pull/22568))
- Add `aria-hidden` to footer circle dividers to improve accessibility ([hs4man21](https://github.com/tucano/tucano/pull/22576))
- Add `lang` attribute to compose form inputs ([ClearlyClaire](https://github.com/tucano/tucano/pull/23240))

### Changed

- **Ensure exact match is the first result in hashtag searches** ([ClearlyClaire](https://github.com/tucano/tucano/pull/21315))
- Change account search to return followed accounts first ([dariusk](https://github.com/tucano/tucano/pull/22956))
- Change batch account suspension to create a strike ([ClearlyClaire](https://github.com/tucano/tucano/pull/20897))
- Change default reply language to match the default language when replying to a translated post ([ClearlyClaire](https://github.com/tucano/tucano/pull/22272))
- Change misleading wording about waitlists ([ClearlyClaire](https://github.com/tucano/tucano/pull/20850))
- Increase width of the unread notification border ([connorshea](https://github.com/tucano/tucano/pull/21692))
- Change new post notification button on profiles to make it more apparent when it is enabled ([tribela](https://github.com/tucano/tucano/pull/22541))
- Change trending tags admin interface to always show batch action controls ([ClearlyClaire](https://github.com/tucano/tucano/pull/23013))
- Change wording of some OAuth scope descriptions ([ClearlyClaire](https://github.com/tucano/tucano/pull/22491))
- Change wording of admin report handling actions ([ClearlyClaire](https://github.com/tucano/tucano/pull/18388))
- Change confirm prompts for relationships management ([tribela](https://github.com/tucano/tucano/pull/19411))
- Change language surrounding disability in prompts for media descriptions ([hs4man21](https://github.com/tucano/tucano/pull/20923))
- Change confusing wording in the sign in banner ([ClearlyClaire](https://github.com/tucano/tucano/pull/22490))
- Change `POST /settings/applications/:id` to regenerate token on scopes change ([ClearlyClaire](https://github.com/tucano/tucano/pull/23359))
- Change account moderation notes to make links clickable ([ClearlyClaire](https://github.com/tucano/tucano/pull/22553))
- Change link previews for statuses to never use avatar as fallback ([Gargron](https://github.com/tucano/tucano/pull/23376))
- Change email address input to be read-only for logged-in users when requesting a new confirmation e-mail ([ClearlyClaire](https://github.com/tucano/tucano/pull/23247))
- Change notifications per page from 15 to 40 in REST API ([Gargron](https://github.com/tucano/tucano/pull/23348))
- Change number of stored items in home feed from 400 to 800 ([Gargron](https://github.com/tucano/tucano/pull/23349))
- Change API rate limits from 300/5min per user to 1500/5min per user, 300/5min per app ([Gargron](https://github.com/tucano/tucano/pull/23347))
- Save avatar or header correctly even if the other one fails ([tribela](https://github.com/tucano/tucano/pull/18465))
- Change `referrer-policy` to `same-origin` application-wide ([ClearlyClaire](https://github.com/tucano/tucano/pull/23014), [ClearlyClaire](https://github.com/tucano/tucano/pull/23037))
- Add 'private' to `Cache-Control`, match Rails expectations ([daxtens](https://github.com/tucano/tucano/pull/20608))
- Make the button that expands the compose form differentiable from the button that publishes a post ([Tak](https://github.com/tucano/tucano/pull/20864))
- Change automatic post deletion configuration to be accessible to moved users ([ClearlyClaire](https://github.com/tucano/tucano/pull/20774))
- Make tag following idempotent ([trwnh](https://github.com/tucano/tucano/pull/20860), [ClearlyClaire](https://github.com/tucano/tucano/pull/21285))
- Use buildx functions for faster builds ([inductor](https://github.com/tucano/tucano/pull/20692))
- Split off Dockerfile components for faster builds ([moritzheiber](https://github.com/tucano/tucano/pull/20933), [ineffyble](https://github.com/tucano/tucano/pull/20948), [BtbN](https://github.com/tucano/tucano/pull/21028))
- Change last occurrence of “silence” to “limit” in UI text ([cincodenada](https://github.com/tucano/tucano/pull/20637))
- Change “hide toot” to “hide post” ([seanthegeek](https://github.com/tucano/tucano/pull/22385))
- Don't allow URLs that contain non-normalized paths to be verified ([dgl](https://github.com/tucano/tucano/pull/20999))
- Change the “Trending now” header to be a link to the Explore page ([connorshea](https://github.com/tucano/tucano/pull/21759))
- Change PostgreSQL connection timeout from 2 minutes to 15 seconds ([ClearlyClaire](https://github.com/tucano/tucano/pull/21790))
- Make handle more easily selectable on profile page ([cadars](https://github.com/tucano/tucano/pull/21479))
- Allow admins to refresh remotely-suspended accounts ([ClearlyClaire](https://github.com/tucano/tucano/pull/22327))
- Change dropdown menu to contain “Copy link to post” even for non-public posts ([ClearlyClaire](https://github.com/tucano/tucano/pull/21316))
- Allow adding relays in secure mode and limited federation mode ([ineffyble](https://github.com/tucano/tucano/pull/22324))
- Change timestamps to be displayed using the user's timezone throughout the moderation interface ([FrancisMurillo](https://github.com/tucano/tucano/pull/21878), [ClearlyClaire](https://github.com/tucano/tucano/pull/22555))
- Change CSP directives on API to be tight and concise ([ClearlyClaire](https://github.com/tucano/tucano/pull/20960))
- Change web UI to not autofocus the compose form ([raboof](https://github.com/tucano/tucano/pull/16517), [Akkiesoft](https://github.com/tucano/tucano/pull/23094))
- Change idempotency key handling for posting when database access is slow ([lambda](https://github.com/tucano/tucano/pull/21840))
- Change remote media files to be downloaded outside of transactions ([ClearlyClaire](https://github.com/tucano/tucano/pull/21796))
- Improve contrast of charts in “poll has ended” notifications ([j-f1](https://github.com/tucano/tucano/pull/22575))
- Change OEmbed detection and validation to be somewhat more lenient ([ineffyble](https://github.com/tucano/tucano/pull/22533))
- Widen ElasticSearch version detection to not display a warning for OpenSearch ([VyrCossont](https://github.com/tucano/tucano/pull/22422), [ClearlyClaire](https://github.com/tucano/tucano/pull/23064))
- Change link verification to allow pages larger than 1MB as long as the link is in the first 1MB ([untitaker](https://github.com/tucano/tucano/pull/22879))
- Update default Node.js version to Node.js 16 ([ineffyble](https://github.com/tucano/tucano/pull/22223), [ClearlyClaire](https://github.com/tucano/tucano/pull/22342))

### Removed

- Officially remove support for Ruby 2.6 ([ClearlyClaire](https://github.com/tucano/tucano/pull/21477))
- Remove `object-fit` polyfill used for old versions of Microsoft Edge ([shuuji3](https://github.com/tucano/tucano/pull/22693))
- Remove `intersection-observer` polyfill for old Safari support ([shuuji3](https://github.com/tucano/tucano/pull/23284))
- Remove empty `title` tag from mailer layout ([nametoolong](https://github.com/tucano/tucano/pull/23078))
- Remove post count and last posts from ActivityPub representation of hashtag collections ([ClearlyClaire](https://github.com/tucano/tucano/pull/23460))

### Fixed

- **Fix changing domain block severity not undoing individual account effects** ([ClearlyClaire](https://github.com/tucano/tucano/pull/22135))
- Fix suspension worker crashing on S3-compatible setups without ACL support ([ClearlyClaire](https://github.com/tucano/tucano/pull/22487))
- Fix possible race conditions when suspending/unsuspending accounts ([ClearlyClaire](https://github.com/tucano/tucano/pull/22363))
- Fix being stuck in edit mode when deleting the edited posts ([ClearlyClaire](https://github.com/tucano/tucano/pull/22126))
- Fix attached media uploads not being cleared when replying to a post ([ClearlyClaire](https://github.com/tucano/tucano/pull/23504))
- Fix filters not being applied to some notification types ([ClearlyClaire](https://github.com/tucano/tucano/pull/23211))
- Fix incorrect link in push notifications for some event types ([elizabeth-dev](https://github.com/tucano/tucano/pull/23286))
- Fix some performance issues with `/admin/instances` ([ClearlyClaire](https://github.com/tucano/tucano/pull/21907))
- Fix some pre-4.0 admin audit logs ([ClearlyClaire](https://github.com/tucano/tucano/pull/22091))
- Fix moderation audit log items for warnings having incorrect links ([ClearlyClaire](https://github.com/tucano/tucano/pull/23242))
- Fix account activation being sometimes triggered before email confirmation ([ClearlyClaire](https://github.com/tucano/tucano/pull/23245))
- Fix missing OAuth scopes for admin APIs ([trwnh](https://github.com/tucano/tucano/pull/20918), [trwnh](https://github.com/tucano/tucano/pull/20979))
- Fix voter count not being cleared when a poll is reset ([afontenot](https://github.com/tucano/tucano/pull/21700))
- Fix attachments of edited posts not being fetched ([ClearlyClaire](https://github.com/tucano/tucano/pull/21565))
- Fix irreversible and whole_word parameters handling in `/api/v1/filters` ([ClearlyClaire](https://github.com/tucano/tucano/pull/21988))
- Fix 500 error when marking posts as sensitive while some of them are deleted ([ClearlyClaire](https://github.com/tucano/tucano/pull/22134))
- Fix expanded posts not always being scrolled into view ([ClearlyClaire](https://github.com/tucano/tucano/pull/21797))
- Fix not being able to scroll the remote interaction modal on small screens ([xendke](https://github.com/tucano/tucano/pull/21763))
- Fix not being able to scroll in post history modal ([cadars](https://github.com/tucano/tucano/pull/23396))
- Fix audio player volume control on Safari ([minacle](https://github.com/tucano/tucano/pull/23187))
- Fix disappearing “Explore” tabs on Safari ([nyura](https://github.com/tucano/tucano/pull/20917), [ykzts](https://github.com/tucano/tucano/pull/20982))
- Fix wrong padding in RTL layout ([Gargron](https://github.com/tucano/tucano/pull/23157))
- Fix drag & drop upload area display in single-column mode ([ClearlyClaire](https://github.com/tucano/tucano/pull/23217))
- Fix being unable to get a single EmailDomainBlock from the admin API ([trwnh](https://github.com/tucano/tucano/pull/20846))
- Fix admin-set follow recommandations being case-sensitive ([ClearlyClaire](https://github.com/tucano/tucano/pull/23500))
- Fix unserialized `role` on account entities in admin API ([Gargron](https://github.com/tucano/tucano/pull/23290))
- Fix pagination of followed tags ([trwnh](https://github.com/tucano/tucano/pull/20861))
- Fix dropdown menu positions when scrolling ([sidp](https://github.com/tucano/tucano/pull/22916), [ClearlyClaire](https://github.com/tucano/tucano/pull/23062))
- Fix email with empty domain name labels passing validation ([ClearlyClaire](https://github.com/tucano/tucano/pull/23246))
- Fix mysterious registration failure when “Require a reason to join” is set with open registrations ([ClearlyClaire](https://github.com/tucano/tucano/pull/22127))
- Fix attachment rendering of edited posts in OpenGraph ([ClearlyClaire](https://github.com/tucano/tucano/pull/22270))
- Fix invalid/empty RSS feed link on account pages ([ClearlyClaire](https://github.com/tucano/tucano/pull/20772))
- Fix error in `VerifyLinkService` when processing links with no href ([joshuap](https://github.com/tucano/tucano/pull/20741))
- Fix error in `VerifyLinkService` when processing links with invalid URLs ([untitaker](https://github.com/tucano/tucano/pull/23204))
- Fix media uploads with FFmpeg 5 ([dead10ck](https://github.com/tucano/tucano/pull/21191))
- Fix sensitive flag not being set when replying to a post with a content warning under certain conditions ([kedamaDQ](https://github.com/tucano/tucano/pull/21724))
- Fix misleading message briefly showing up when loading follow requests under some conditions ([c960657](https://github.com/tucano/tucano/pull/23386))
- Fix “Share @:user's profile” profile menu item not working ([ClearlyClaire](https://github.com/tucano/tucano/pull/21490))
- Fix crash and incorrect behavior in `tootctl domains crawl` ([ClearlyClaire](https://github.com/tucano/tucano/pull/19004))
- Fix autoplay on iOS ([jamesadney](https://github.com/tucano/tucano/pull/21422))
- Fix user clean-up scheduler crash when an unconfirmed account has a moderation note ([ClearlyClaire](https://github.com/tucano/tucano/pull/23318))
- Fix spaces not being stripped in admin account search ([ClearlyClaire](https://github.com/tucano/tucano/pull/21324))
- Fix spaces not being stripped when adding relays ([ClearlyClaire](https://github.com/tucano/tucano/pull/22655))
- Fix infinite loading spinner instead of soft 404 for non-existing remote accounts ([ClearlyClaire](https://github.com/tucano/tucano/pull/21303))
- Fix minor visual issue with the top border of verified account fields ([j-f1](https://github.com/tucano/tucano/pull/22006))
- Fix pending account approval and rejection not being recorded in the admin audit log ([FrancisMurillo](https://github.com/tucano/tucano/pull/22088))
- Fix “Sign up” button with closed registrations not opening modal on mobile ([ClearlyClaire](https://github.com/tucano/tucano/pull/22060))
- Fix UI header overflowing on mobile ([ClearlyClaire](https://github.com/tucano/tucano/pull/21783))
- Fix 500 error when trying to migrate to an invalid address ([ClearlyClaire](https://github.com/tucano/tucano/pull/21462))
- Fix crash when trying to fetch unobtainable avatar of user using external authentication ([lochiiconnectivity](https://github.com/tucano/tucano/pull/22462))
- Fix processing error on incoming malformed JSON-LD under some situations ([ClearlyClaire](https://github.com/tucano/tucano/pull/23416))
- Fix potential duplicate posts in Explore tab ([ClearlyClaire](https://github.com/tucano/tucano/pull/22121))
- Fix deprecation warning in `tootctl accounts rotate` ([ClearlyClaire](https://github.com/tucano/tucano/pull/22120))
- Fix styling of featured tags in light theme ([ClearlyClaire](https://github.com/tucano/tucano/pull/23252))
- Fix missing style in warning and strike cards ([AtelierSnek](https://github.com/tucano/tucano/pull/22177), [ClearlyClaire](https://github.com/tucano/tucano/pull/22302))
- Fix wasteful request to `/api/v1/custom_emojis` when not logged in ([ClearlyClaire](https://github.com/tucano/tucano/pull/22326))
- Fix replies sometimes being delivered to user-blocked domains ([tribela](https://github.com/tucano/tucano/pull/22117))
- Fix admin dashboard crash when using some ElasticSearch replacements ([cortices](https://github.com/tucano/tucano/pull/21006))
- Fix profile avatar being slightly offset into left border ([RiedleroD](https://github.com/tucano/tucano/pull/20994))
- Fix N+1 queries in `NotificationsController` ([nametoolong](https://github.com/tucano/tucano/pull/21202))
- Fix being unable to react to announcements with the keycap number sign emoji ([kescherCode](https://github.com/tucano/tucano/pull/22231))
- Fix height computation of post embeds ([hodgesmr](https://github.com/tucano/tucano/pull/22141))
- Fix accessibility issue of the search bar due to hidden placeholder ([alexstine](https://github.com/tucano/tucano/pull/21275))
- Fix layout change handler not being removed due to a typo ([nschonni](https://github.com/tucano/tucano/pull/21829))
- Fix typo in the default `S3_HOSTNAME` used in the `tucano:setup` rake task ([danp](https://github.com/tucano/tucano/pull/19932))
- Fix the top action bar appearing in the multi-column layout ([ClearlyClaire](https://github.com/tucano/tucano/pull/20943))
- Fix inability to use local LibreTranslate without setting `ALLOWED_PRIVATE_ADDRESSES` ([ClearlyClaire](https://github.com/tucano/tucano/pull/21926))
- Fix punycoded local domains not being prettified in initial state ([Tritlo](https://github.com/tucano/tucano/pull/21440))
- Fix CSP violation warning by removing inline CSS from SVG logo ([luxiaba](https://github.com/tucano/tucano/pull/20814))
- Fix margin for search field on medium window size ([minacle](https://github.com/tucano/tucano/pull/21606))
- Fix search popout scrolling with the page in single-column mode ([rgroothuijsen](https://github.com/tucano/tucano/pull/16463))
- Fix minor post cache hydration discrepancy ([ClearlyClaire](https://github.com/tucano/tucano/pull/19879))
- Fix `・` detection in hashtags ([parthoghosh24](https://github.com/tucano/tucano/pull/22888))
- Fix hashtag follows bypassing user blocks ([tribela](https://github.com/tucano/tucano/pull/22849))
- Fix moved accounts being incorrectly redirected to account settings when trying to view a remote profile ([ClearlyClaire](https://github.com/tucano/tucano/pull/22497))
- Fix site upload validations ([ClearlyClaire](https://github.com/tucano/tucano/pull/22479))
- Fix “Add new domain block” button using last submitted search value instead of the current one ([ClearlyClaire](https://github.com/tucano/tucano/pull/22485))
- Fix misleading hashtag warning when posting with “Followers only” or “Mentioned people only” visibility ([n0toose](https://github.com/tucano/tucano/pull/22827))
- Fix embedded posts with videos grabbing focus ([Akkiesoft](https://github.com/tucano/tucano/pull/22778))
- Fix `$` not being escaped in `.env.production` files generated by the `tucano:setup` rake task ([ClearlyClaire](https://github.com/tucano/tucano/pull/23012), [ClearlyClaire](https://github.com/tucano/tucano/pull/23072))
- Fix sanitizer parsing link text as HTML when stripping unsupported links ([ClearlyClaire](https://github.com/tucano/tucano/pull/22558))
- Fix `scheduled_at` input not using `datetime-local` when editing announcements ([ClearlyClaire](https://github.com/tucano/tucano/pull/21896))
- Fix REST API serializer for `Account` not including `moved` when the moved account has itself moved ([ClearlyClaire](https://github.com/tucano/tucano/pull/22483))
- Fix `/api/v1/admin/trends/tags` using wrong serializer ([ClearlyClaire](https://github.com/tucano/tucano/pull/18943))
- Fix situations in which instance actor can be set to a tucano-incompatible name ([ClearlyClaire](https://github.com/tucano/tucano/pull/22307))

### Security

- Add `form-action` CSP directive ([ClearlyClaire](https://github.com/tucano/tucano/pull/20781), [ClearlyClaire](https://github.com/tucano/tucano/pull/20958), [ClearlyClaire](https://github.com/tucano/tucano/pull/20962))
- Fix unbounded recursion in account discovery ([ClearlyClaire](https://github.com/tucano/tucano/pull/22025))
- Revoke all authorized applications on password reset ([FrancisMurillo](https://github.com/tucano/tucano/pull/21325))
- Fix unbounded recursion in post discovery ([ClearlyClaire,nametoolong](https://github.com/tucano/tucano/pull/23506))

## [4.0.2] - 2022-11-15

### Fixed

- Fix wrong color on mentions hidden behind content warning in web UI ([Gargron](https://github.com/tucano/tucano/pull/20724))
- Fix filters from other users being used in the streaming service ([ClearlyClaire](https://github.com/tucano/tucano/pull/20719))
- Fix `unsafe-eval` being used when `wasm-unsafe-eval` is enough in Content Security Policy ([Gargron](https://github.com/tucano/tucano/pull/20729), [prplecake](https://github.com/tucano/tucano/pull/20606))

## [4.0.1] - 2022-11-14

### Fixed

- Fix nodes order being sometimes mangled when rewriting emoji ([ClearlyClaire](https://github.com/tucano/tucano/pull/20677))
...
- Add ability to filter followed accounts' posts by language ([Gargron](https://github.com/tucano/tucano/pull/19095), [ClearlyClaire](https://github.com/tucano/tucano/pull/19268))
- **Add ability to follow hashtags** ([Gargron](https://github.com/tucano/tucano/pull/18809), [Gargron](https://github.com/tucano/tucano/pull/18862), [Gargron](https://github.com/tucano/tucano/pull/19472), [noellabo](https://github.com/tucano/tucano/pull/18924))
- Add ability to filter individual posts ([ClearlyClaire](https://github.com/tucano/tucano/pull/18945))
- **Add ability to translate posts** ([Gargron](https://github.com/tucano/tucano/pull/19218), [ClearlyClaire](https://github.com/tucano/tucano/pull/19433), [Gargron](https://github.com/tucano/tucano/pull/19453), [ClearlyClaire](https://github.com/tucano/tucano/pull/19434), [Gargron](https://github.com/tucano/tucano/pull/19388), [ykzts](https://github.com/tucano/tucano/pull/19244), [Gargron](https://github.com/tucano/tucano/pull/19245))
- Add featured tags to web UI ([noellabo](https://github.com/tucano/tucano/pull/19408), [noellabo](https://github.com/tucano/tucano/pull/19380), [noellabo](https://github.com/tucano/tucano/pull/19358), [noellabo](https://github.com/tucano/tucano/pull/19409), [Gargron](https://github.com/tucano/tucano/pull/19382), [ykzts](https://github.com/tucano/tucano/pull/19418), [noellabo](https://github.com/tucano/tucano/pull/19403), [noellabo](https://github.com/tucano/tucano/pull/19404), [Gargron](https://github.com/tucano/tucano/pull/19398), [Gargron](https://github.com/tucano/tucano/pull/19712), [ClearlyClaire](https://github.com/tucano/tucano/pull/20018))
- **Add support for language preferences for trending statuses and links** ([Gargron](https://github.com/tucano/tucano/pull/18288), [Gargron](https://github.com/tucano/tucano/pull/19349), [ykzts](https://github.com/tucano/tucano/pull/19335))
...
- Add server rules to sign-up flow ([Gargron](https://github.com/tucano/tucano/pull/19296))
- Add privacy icons to report modal in web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/19190))
- Add `noopener` to links to remote profiles in web UI ([shleeable](https://github.com/tucano/tucano/pull/19014))
- Add option to open original page in dropdowns of remote content in web UI ([Gargron](https://github.com/tucano/tucano/pull/20299))
- Add warning for sensitive audio posts in web UI ([rgroothuijsen](https://github.com/tucano/tucano/pull/17885))
- Add language attribute to posts in web UI ([tribela](https://github.com/tucano/tucano/pull/18544))
- Add support for uploading WebP files ([Saiv46](https://github.com/tucano/tucano/pull/18506))
- Add support for uploading `audio/vnd.wave` files ([tribela](https://github.com/tucano/tucano/pull/18737))
- Add support for uploading AVIF files ([txt-file](https://github.com/tucano/tucano/pull/19647))
- Add support for uploading HEIC files ([Gargron](https://github.com/tucano/tucano/pull/19618))
- Add more debug information when processing remote accounts ([ClearlyClaire](https://github.com/tucano/tucano/pull/15605), [ClearlyClaire](https://github.com/tucano/tucano/pull/19209))
- **Add retention policy for cached content and media** ([Gargron](https://github.com/tucano/tucano/pull/19232), [zunda](https://github.com/tucano/tucano/pull/19478), [Gargron](https://github.com/tucano/tucano/pull/19458), [Gargron](https://github.com/tucano/tucano/pull/19248))
  - Set for how long remote posts or media should be cached on your server
  - Hands-off alternative to `tootctl` commands
- **Add customizable user roles** ([Gargron](https://github.com/tucano/tucano/pull/18641), [ClearlyClaire](https://github.com/tucano/tucano/pull/18812), [Gargron](https://github.com/tucano/tucano/pull/19040), [tribela](https://github.com/tucano/tucano/pull/18825), [tribela](https://github.com/tucano/tucano/pull/18826), [ClearlyClaire](https://github.com/tucano/tucano/pull/18776), [ClearlyClaire](https://github.com/tucano/tucano/pull/18777), [unextro](https://github.com/tucano/tucano/pull/18786), [tribela](https://github.com/tucano/tucano/pull/18824), [ClearlyClaire](https://github.com/tucano/tucano/pull/19436))
...
- Add notifications for new reports ([Gargron](https://github.com/tucano/tucano/pull/18697), [Gargron](https://github.com/tucano/tucano/pull/19475))
- Add ability to select all accounts matching search for batch actions in admin UI ([Gargron](https://github.com/tucano/tucano/pull/19053), [Gargron](https://github.com/tucano/tucano/pull/19054))
- Add ability to view previous edits of a status in admin UI ([Gargron](https://github.com/tucano/tucano/pull/19462))
- Add ability to block sign-ups from IP ([Gargron](https://github.com/tucano/tucano/pull/19037))
- **Add webhooks to admin UI** ([Gargron](https://github.com/tucano/tucano/pull/18510))
- Add admin API for managing domain allows ([ClearlyClaire](https://github.com/tucano/tucano/pull/18668))
- Add admin API for managing domain blocks ([ClearlyClaire](https://github.com/tucano/tucano/pull/18247))
- Add admin API for managing e-mail domain blocks ([Gargron](https://github.com/tucano/tucano/pull/19066))
- Add admin API for managing canonical e-mail blocks ([Gargron](https://github.com/tucano/tucano/pull/19067))
- Add admin API for managing IP blocks ([Gargron](https://github.com/tucano/tucano/pull/19065), [trwnh](https://github.com/tucano/tucano/pull/20207))
- Add `sensitized` attribute to accounts in admin REST API ([trwnh](https://github.com/tucano/tucano/pull/20094))
- Add `services` and `metadata` to the NodeInfo endpoint ([MFTabriz](https://github.com/tucano/tucano/pull/18563))
- Add `--remove-role` option to `tootctl accounts modify` ([Gargron](https://github.com/tucano/tucano/pull/19477))
- Add `--days` option to `tootctl media refresh` ([tribela](https://github.com/tucano/tucano/pull/18425))
- Add `EMAIL_DOMAIN_LISTS_APPLY_AFTER_CONFIRMATION` environment variable ([ClearlyClaire](https://github.com/tucano/tucano/pull/18642))
- Add `IP_RETENTION_PERIOD` and `SESSION_RETENTION_PERIOD` environment variables ([kescherCode](https://github.com/tucano/tucano/pull/18757))
- Add `http_hidden_proxy` environment variable ([tribela](https://github.com/tucano/tucano/pull/18427))
- Add `ENABLE_STARTTLS` environment variable ([erbridge](https://github.com/tucano/tucano/pull/20321))
- Add caching for payload serialization during fan-out ([ClearlyClaire](https://github.com/tucano/tucano/pull/19637), [Gargron](https://github.com/tucano/tucano/pull/19642), [ClearlyClaire](https://github.com/tucano/tucano/pull/19746), [ClearlyClaire](https://github.com/tucano/tucano/pull/19747), [ClearlyClaire](https://github.com/tucano/tucano/pull/19963))
- Add assets from Twemoji 14.0 ([Gargron](https://github.com/tucano/tucano/pull/19733))
- Add reputation and followers score boost to SQL-only account search ([Gargron](https://github.com/tucano/tucano/pull/19251))
- Add Scots, Balaibalan, Láadan, Lingua Franca Nova, Lojban, Toki Pona to languages list ([VyrCossont](https://github.com/tucano/tucano/pull/20168))
- Set autocomplete hints for e-mail, password and OTP fields ([rcombs](https://github.com/tucano/tucano/pull/19833), [offbyone](https://github.com/tucano/tucano/pull/19946), [ClearlyClaire](https://github.com/tucano/tucano/pull/20071))
- Add support for DigitalOcean Spaces in setup wizard ([v-aisac](https://github.com/tucano/tucano/pull/20573))

### Changed

- **Change brand color and logotypes** ([Gargron](https://github.com/tucano/tucano/pull/18592), [Gargron](https://github.com/tucano/tucano/pull/18639), [Gargron](https://github.com/tucano/tucano/pull/18691), [ClearlyClaire](https://github.com/tucano/tucano/pull/18634), [Gargron](https://github.com/tucano/tucano/pull/19254), [mayaeh](https://github.com/tucano/tucano/pull/18710))
- **Change post editing to be enabled in web UI** ([Gargron](https://github.com/tucano/tucano/pull/19103))
- **Change web UI to work for logged-out users** ([Gargron](https://github.com/tucano/tucano/pull/18961), [Gargron](https://github.com/tucano/tucano/pull/19250), [Gargron](https://github.com/tucano/tucano/pull/19294), [Gargron](https://github.com/tucano/tucano/pull/19306), [Gargron](https://github.com/tucano/tucano/pull/19315), [ykzts](https://github.com/tucano/tucano/pull/19322), [Gargron](https://github.com/tucano/tucano/pull/19412), [ClearlyClaire](https://github.com/tucano/tucano/pull/19437), [ClearlyClaire](https://github.com/tucano/tucano/pull/19415), [Gargron](https://github.com/tucano/tucano/pull/19348), [Gargron](https://github.com/tucano/tucano/pull/19295), [Gargron](https://github.com/tucano/tucano/pull/19422), [ClearlyClaire](https://github.com/tucano/tucano/pull/19414), [Gargron](https://github.com/tucano/tucano/pull/19319), [Gargron](https://github.com/tucano/tucano/pull/19345), [Gargron](https://github.com/tucano/tucano/pull/19310), [Gargron](https://github.com/tucano/tucano/pull/19301), [Gargron](https://github.com/tucano/tucano/pull/19423), [ykzts](https://github.com/tucano/tucano/pull/19471), [ykzts](https://github.com/tucano/tucano/pull/19333), [ykzts](https://github.com/tucano/tucano/pull/19337), [ykzts](https://github.com/tucano/tucano/pull/19272), [ykzts](https://github.com/tucano/tucano/pull/19468), [Gargron](https://github.com/tucano/tucano/pull/19466), [Gargron](https://github.com/tucano/tucano/pull/19457), [Gargron](https://github.com/tucano/tucano/pull/19426), [Gargron](https://github.com/tucano/tucano/pull/19427), [Gargron](https://github.com/tucano/tucano/pull/19421), [Gargron](https://github.com/tucano/tucano/pull/19417), [Gargron](https://github.com/tucano/tucano/pull/19413), [Gargron](https://github.com/tucano/tucano/pull/19397), [Gargron](https://github.com/tucano/tucano/pull/19387), [Gargron](https://github.com/tucano/tucano/pull/19396), [Gargron](https://github.com/tucano/tucano/pull/19385), [ykzts](https://github.com/tucano/tucano/pull/19334), [ykzts](https://github.com/tucano/tucano/pull/19329), [Gargron](https://github.com/tucano/tucano/pull/19324), [Gargron](https://github.com/tucano/tucano/pull/19318), [Gargron](https://github.com/tucano/tucano/pull/19316), [Gargron](https://github.com/tucano/tucano/pull/19263), [trwnh](https://github.com/tucano/tucano/pull/19305), [ykzts](https://github.com/tucano/tucano/pull/19273), [Gargron](https://github.com/tucano/tucano/pull/19801), [Gargron](https://github.com/tucano/tucano/pull/19790), [ClearlyClaire](https://github.com/tucano/tucano/pull/19773), [Gargron](https://github.com/tucano/tucano/pull/19798), [ClearlyClaire](https://github.com/tucano/tucano/pull/19724), [Gargron](https://github.com/tucano/tucano/pull/19709), [Gargron](https://github.com/tucano/tucano/pull/19514), [Gargron](https://github.com/tucano/tucano/pull/19562), [ClearlyClaire](https://github.com/tucano/tucano/pull/19981), [ClearlyClaire](https://github.com/tucano/tucano/pull/19978), [ClearlyClaire](https://github.com/tucano/tucano/pull/20148), [Gargron](https://github.com/tucano/tucano/pull/20302), [cutls](https://github.com/tucano/tucano/pull/20400))
...
- Change label of publish button to be "Publish" again in web UI ([Gargron](https://github.com/tucano/tucano/pull/18583))
- Change language to be carried over on reply in web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/18557))
- Change "Unfollow" to "Cancel follow request" when request still pending in web UI ([prplecake](https://github.com/tucano/tucano/pull/19363))
- **Change post filtering system** ([ClearlyClaire](https://github.com/tucano/tucano/pull/18058), [ClearlyClaire](https://github.com/tucano/tucano/pull/19050), [ClearlyClaire](https://github.com/tucano/tucano/pull/18894), [ClearlyClaire](https://github.com/tucano/tucano/pull/19051), [noellabo](https://github.com/tucano/tucano/pull/18923), [ClearlyClaire](https://github.com/tucano/tucano/pull/18956), [ClearlyClaire](https://github.com/tucano/tucano/pull/18744), [ClearlyClaire](https://github.com/tucano/tucano/pull/19878), [ClearlyClaire](https://github.com/tucano/tucano/pull/20567))
...
- Change path of privacy policy page from `/terms` to `/privacy-policy` ([Gargron](https://github.com/tucano/tucano/pull/19249))
- Change how hashtags are normalized ([Gargron](https://github.com/tucano/tucano/pull/18795), [Gargron](https://github.com/tucano/tucano/pull/18863), [ClearlyClaire](https://github.com/tucano/tucano/pull/18854))
- Change settings area to be separated into categories in admin UI ([Gargron](https://github.com/tucano/tucano/pull/19407), [Gargron](https://github.com/tucano/tucano/pull/19533))
- Change "No accounts selected" errors to use the appropriate noun in admin UI ([prplecake](https://github.com/tucano/tucano/pull/19356))
- Change e-mail domain blocks to match subdomains of blocked domains ([Gargron](https://github.com/tucano/tucano/pull/18979))
- Change custom emoji file size limit from 50 KB to 256 KB ([Gargron](https://github.com/tucano/tucano/pull/18788))
- Change "Allow trends without prior review" setting to also work for trending posts ([Gargron](https://github.com/tucano/tucano/pull/17977))
- Change admin announcements form to use single inputs for date and time in admin UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/18321))
- Change search API to be accessible without being logged in ([Gargron](https://github.com/tucano/tucano/pull/18963), [Gargron](https://github.com/tucano/tucano/pull/19326))
- Change following and followers API to be accessible without being logged in ([Gargron](https://github.com/tucano/tucano/pull/18964))
- Change `AUTHORIZED_FETCH` to not block unauthenticated REST API access ([Gargron](https://github.com/tucano/tucano/pull/19803))
- Change Helm configuration ([deepy](https://github.com/tucano/tucano/pull/18997), [jgsmith](https://github.com/tucano/tucano/pull/18415), [deepy](https://github.com/tucano/tucano/pull/18941))
- Change mentions of blocked users to not be processed ([ClearlyClaire](https://github.com/tucano/tucano/pull/19725))
- Change max. thumbnail dimensions to 640x360px (360p) ([Gargron](https://github.com/tucano/tucano/pull/19619))
- Change post-processing to be deferred only for large media types ([Gargron](https://github.com/tucano/tucano/pull/19617))
- Change link verification to only work for https links without unicode ([Gargron](https://github.com/tucano/tucano/pull/20304), [Gargron](https://github.com/tucano/tucano/pull/20295))
- Change account deletion requests to spread out over time ([ClearlyClaire](https://github.com/tucano/tucano/pull/20222))
- Change larger reblogs/favourites numbers to be shortened in web UI ([Gargron](https://github.com/tucano/tucano/pull/20303))
- Change incoming activity processing to happen in `ingress` queue ([Gargron](https://github.com/tucano/tucano/pull/20264))
- Change notifications to not link show preview cards in web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/20335))
- Change amount of replies returned for logged out users in REST API ([ClearlyClaire](https://github.com/tucano/tucano/pull/20355))
- Change in-app links to keep you in-app in web UI ([trwnh](https://github.com/tucano/tucano/pull/20540), [Gargron](https://github.com/tucano/tucano/pull/20628))
- Change table header to be sticky in admin UI ([sk22](https://github.com/tucano/tucano/pull/20442))

### Removed

- Remove setting that disables account deletes ([Gargron](https://github.com/tucano/tucano/pull/17683))
- Remove digest e-mails ([Gargron](https://github.com/tucano/tucano/pull/17985))
- Remove unnecessary sections from welcome e-mail ([Gargron](https://github.com/tucano/tucano/pull/19299))
- Remove item titles from RSS feeds ([Gargron](https://github.com/tucano/tucano/pull/18640))
- Remove volume number from hashtags in web UI ([Gargron](https://github.com/tucano/tucano/pull/19253))
- Remove Nanobox configuration ([tonyjiang](https://github.com/tucano/tucano/pull/17881))

### Fixed

- Fix rules with same priority being sorted non-deterministically ([Gargron](https://github.com/tucano/tucano/pull/20623))
- Fix error when invalid domain name is submitted ([Gargron](https://github.com/tucano/tucano/pull/19474))
- Fix icons having an image role ([Gargron](https://github.com/tucano/tucano/pull/20600))
- Fix connections to IPv6-only servers ([ClearlyClaire](https://github.com/tucano/tucano/pull/20108))
- Fix unnecessary service worker registration and preloading when logged out in web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/20341))
- Fix unnecessary and slow regex construction ([raggi](https://github.com/tucano/tucano/pull/20215))
- Fix `mailers` queue not being used for mailers ([Gargron](https://github.com/tucano/tucano/pull/20274))
- Fix error in webfinger redirect handling ([ClearlyClaire](https://github.com/tucano/tucano/pull/20260))
- Fix report category not being set to `violation` if rule IDs are provided ([trwnh](https://github.com/tucano/tucano/pull/20137))
- Fix nodeinfo metadata attribute being an array instead of an object ([ClearlyClaire](https://github.com/tucano/tucano/pull/20114))
- Fix account endorsements not being idempotent ([trwnh](https://github.com/tucano/tucano/pull/20118))
- Fix status and rule IDs not being strings in admin reports REST API ([trwnh](https://github.com/tucano/tucano/pull/20122))
- Fix error on invalid `replies_policy` in REST API ([trwnh](https://github.com/tucano/tucano/pull/20126))
- Fix redrafting a currently-editing post not leaving edit mode in web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/20023))
- Fix performance by avoiding method cache busts ([raggi](https://github.com/tucano/tucano/pull/19957))
- Fix opening the language picker scrolling the single-column view to the top in web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/19983))
- Fix content warning button missing `aria-expanded` attribute in web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/19975))
- Fix redundant `aria-pressed` attributes in web UI ([Brawaru](https://github.com/tucano/tucano/pull/19912))
- Fix crash when external auth provider has no display name set ([ClearlyClaire](https://github.com/tucano/tucano/pull/19962))
- Fix followers count not being updated when migrating follows ([ClearlyClaire](https://github.com/tucano/tucano/pull/19998))
- Fix double button to clear emoji search input in web UI ([sunny](https://github.com/tucano/tucano/pull/19888))
- Fix missing null check on applications on strike disputes ([kescherCode](https://github.com/tucano/tucano/pull/19851))
- Fix featured tags not saving preferred casing ([Gargron](https://github.com/tucano/tucano/pull/19732))
- Fix language not being saved when editing status ([Gargron](https://github.com/tucano/tucano/pull/19543))
- Fix not being able to input featured tag with hash symbol ([Gargron](https://github.com/tucano/tucano/pull/19535))
- Fix user clean-up scheduler crash when an unconfirmed account has a moderation note ([ClearlyClaire](https://github.com/tucano/tucano/pull/19629))
- Fix being unable to withdraw follow request when confirmation modal is disabled in web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/19687))
- Fix inaccurate admin log entry for re-sending confirmation e-mails ([ClearlyClaire](https://github.com/tucano/tucano/pull/19674))
- Fix edits not being immediately reflected ([ClearlyClaire](https://github.com/tucano/tucano/pull/19673))
- Fix bookmark import stopping at the first failure ([ClearlyClaire](https://github.com/tucano/tucano/pull/19669))
- Fix account action type validation ([Gargron](https://github.com/tucano/tucano/pull/19476))
- Fix upload progress not communicating processing phase in web UI ([Gargron](https://github.com/tucano/tucano/pull/19530))
- Fix wrong host being used for custom.css when asset host configured ([Gargron](https://github.com/tucano/tucano/pull/19521))
- Fix account migration form ever using outdated account data ([Gargron](https://github.com/tucano/tucano/pull/18429), [nightpool](https://github.com/tucano/tucano/pull/19883))
- Fix error when uploading malformed CSV import ([Gargron](https://github.com/tucano/tucano/pull/19509))
- Fix avatars not using image tags in web UI ([Gargron](https://github.com/tucano/tucano/pull/19488))
- Fix handling of duplicate and out-of-order notifications in web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/19693))
- Fix reblogs being discarded after the reblogged status ([ClearlyClaire](https://github.com/tucano/tucano/pull/19731))
- Fix indexing scheduler trying to index when Elasticsearch is disabled ([Gargron](https://github.com/tucano/tucano/pull/19805))
- Fix n+1 queries when rendering initial state JSON ([Gargron](https://github.com/tucano/tucano/pull/19795))
- Fix n+1 query during status removal ([Gargron](https://github.com/tucano/tucano/pull/19753))
- Fix OCR not working due to Content Security Policy in web UI ([prplecake](https://github.com/tucano/tucano/pull/18817))
- Fix `nofollow` rel being removed in web UI ([Gargron](https://github.com/tucano/tucano/pull/19455))
- Fix language dropdown causing zoom on mobile devices in web UI ([Gargron](https://github.com/tucano/tucano/pull/19428))
- Fix button to dismiss suggestions not showing up in search results in web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/19325))
- Fix language dropdown sometimes not appearing in web UI ([Gargron](https://github.com/tucano/tucano/pull/19246))
- Fix quickly switching notification filters resulting in empty or incorrect list in web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/19052), [ClearlyClaire](https://github.com/tucano/tucano/pull/18960))
- Fix media modal link button in web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/18877))
- Fix error upon successful account migration ([Gargron](https://github.com/tucano/tucano/pull/19386))
- Fix negatives values in search index causing queries to fail ([Gargron](https://github.com/tucano/tucano/pull/19464), [Gargron](https://github.com/tucano/tucano/pull/19481))
- Fix error when searching for invalid URL ([ClearlyClaire](https://github.com/tucano/tucano/pull/18580))
- Fix IP blocks not having a unique index ([Gargron](https://github.com/tucano/tucano/pull/19456))
- Fix remote account in contact account setting not being used ([Gargron](https://github.com/tucano/tucano/pull/19351))
- Fix swallowing mentions of unconfirmed/unapproved users ([ClearlyClaire](https://github.com/tucano/tucano/pull/19191))
- Fix incorrect and slow cache invalidation when blocking domain and removing media attachments ([ClearlyClaire](https://github.com/tucano/tucano/pull/19062))
- Fix HTTPs redirect behaviour when running as I2P service ([gi-yt](https://github.com/tucano/tucano/pull/18929))
- Fix deleted pinned posts potentially counting towards the pinned posts limit ([ClearlyClaire](https://github.com/tucano/tucano/pull/19005))
- Fix compatibility with OpenSSL 3.0 ([ClearlyClaire](https://github.com/tucano/tucano/pull/18449))
- Fix error when a remote report includes a private post the server has no access to ([ClearlyClaire](https://github.com/tucano/tucano/pull/18760))
- Fix suspicious sign-in mails never being sent ([ClearlyClaire](https://github.com/tucano/tucano/pull/18599))
- Fix fallback locale when somehow user's locale is an empty string ([tribela](https://github.com/tucano/tucano/pull/18543))
- Fix avatar/header not being deleted locally when deleted on remote account ([tribela](https://github.com/tucano/tucano/pull/18973))
- Fix missing `,` in Blurhash validation ([noellabo](https://github.com/tucano/tucano/pull/18660))
- Fix order by most recent not working for relationships page in admin UI ([tribela](https://github.com/tucano/tucano/pull/18996))
- Fix uncaught error when invalid date is supplied to API ([Gargron](https://github.com/tucano/tucano/pull/19480))
- Fix REST API sometimes returning HTML on error ([ClearlyClaire](https://github.com/tucano/tucano/pull/19135))
- Fix ambiguous column names in `tootctl media refresh` ([tribela](https://github.com/tucano/tucano/pull/19206))
- Fix ambiguous column names in `tootctl search deploy` ([mashirozx](https://github.com/tucano/tucano/pull/18993))
- Fix `CDN_HOST` not being used in some asset URLs ([tribela](https://github.com/tucano/tucano/pull/18662))
- Fix `CAS_DISPLAY_NAME`, `SAML_DISPLAY_NAME` and `OIDC_DISPLAY_NAME` being ignored ([ClearlyClaire](https://github.com/tucano/tucano/pull/18568))
- Fix various typos in comments throughout the codebase ([luzpaz](https://github.com/tucano/tucano/pull/18604))
- Fix CSV import error when rows include unicode characters ([HamptonMakes](https://github.com/tucano/tucano/pull/20592))

### Security

- Fix being able to spoof link verification ([Gargron](https://github.com/tucano/tucano/pull/20217))
- Fix emoji substitution not applying only to text nodes in backend code ([ClearlyClaire](https://github.com/tucano/tucano/pull/20641))
- Fix emoji substitution not applying only to text nodes in web UI ([ClearlyClaire](https://github.com/tucano/tucano/pull/20640))
- Fix rate limiting for paths with formats ([Gargron](https://github.com/tucano/tucano/pull/20675))
- Fix out-of-bound reads in blurhash transcoder ([delroth](https://github.com/tucano/tucano/pull/20388))

_For previous changes, review the [stable-3.5 branch](https://github.com/tucano/tucano/blob/stable-3.5/CHANGELOG.md)_
