...
import { WordmarkLogo } from 'tucano/components/logo';
import { NavigationPortal } from 'tucano/components/navigation_portal';
import { identityContextPropShape, withIdentity } from 'tucano/identity_context';
import { timelinePreview, trendsEnabled } from 'tucano/initial_state';
import { transientSingleColumn } from 'tucano/is_mobile';
import { canManageReports, canViewAdminDashboard } from 'tucano/permissions';
import { selectUnreadNotificationGroupsCount } from 'tucano/selectors/notifications';
