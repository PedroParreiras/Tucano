...
import { navigateToProfile } from 'tucano/actions/accounts';
import { mentionComposeById } from 'tucano/actions/compose';
import type { NotificationGroup as NotificationGroupModel } from 'tucano/models/notification_group';
