...
import { Badge, AutomatedBadge, GroupBadge } from 'tucano/components/badge';
import { Button } from 'tucano/components/button';
import { CopyIconButton } from 'tucano/components/copy_icon_button';
import { FollowersCounter, FollowingCounter, StatusesCounter } from 'tucano/components/counters';
...
import { autoPlayGif, me, domain as localDomain } from 'tucano/initial_state';
import { PERMISSION_MANAGE_USERS, PERMISSION_MANAGE_FEDERATION } from 'tucano/permissions';
