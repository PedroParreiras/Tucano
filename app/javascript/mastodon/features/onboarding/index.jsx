...
import { focusCompose } from 'tucano/actions/compose';
...
const messages = defineMessages({
  template: { id: 'onboarding.compose.template', defaultMessage: 'Hello #tucano!' },
});
          ...
          <Route path='/start' exact>
            <div className='scrollable privacy-policy'>
              <div className='column-title'>
                ...
                <p><FormattedMessage id='onboarding.start.lead' defaultMessage="Your new tucano account is ready to go. Here's how you can make the most of it:" /></p>
              </div>
              ...
              <div className='onboarding__steps'>
                ...
                <Step to='/start/share' icon='copy' iconComponent={ContentCopyIcon} label={<FormattedMessage id='onboarding.steps.share_profile.title' defaultMessage='Share your profile' />} description={<FormattedMessage id='onboarding.steps.share_profile.body' defaultMessage='Let your friends know how to find you on tucano!' />} />
              </div>
