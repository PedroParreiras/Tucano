...
class VerifyLinkService < BaseService
  def call(field)
    ...
    field.mark_verified!
  rescue OpenSSL::SSL::SSLError, HTTP::Error, Addressable::URI::InvalidURIError, tucano::HostValidationError, tucano::LengthValidationError, IPAddr::AddressFamilyError => e
