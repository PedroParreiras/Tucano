...
class Report < ApplicationRecord
  ...
  # - app/javascript/tucano/features/notifications/components/report.jsx
  # - app/javascript/tucano/features/report/category.jsx
  # - app/javascript/tucano/components/admin/ReportReasonSelector.jsx
  enum :category, {
    other: 0,
    spam: 1_000,
    legal: 1_500,
