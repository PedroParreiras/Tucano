...
class RelationshipFilter
  ...
  def relationship_scope(value)
    ...
    when 'invited'
      ...
      raise tucano::InvalidParameterError, "Unknown relationship: #{value}"
    end
  end
  ...
  def location_scope(value)
    ...
    when 'remote'
      ...
      raise tucano::InvalidParameterError, "Unknown location: #{value}"
    end
  end
  ...
  def order_scope(value)
    ...
    when 'recent'
      ...
      raise tucano::InvalidParameterError, "Unknown order: #{value}"
    end
  end
  ...
  def activity_scope(value)
    ...
    when 'dormant'
      ...
      raise tucano::InvalidParameterError, "Unknown activity: #{value}"
    end
  end
end
